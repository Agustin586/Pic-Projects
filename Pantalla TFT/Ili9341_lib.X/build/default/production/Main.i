...
void main(void) {
    ...
    ili9341_draw_string(170,100,"Agustin Zuliani",0xFFE0,0x0000);
    ili9341_draw_string(10,20,"Controlador: Ili9341",0xF800,0x0000);

    ili9341_fillrect(150,30,120,20,0x001F);

    ili9341_drawrect(50,80,60,180,0x07FF);
