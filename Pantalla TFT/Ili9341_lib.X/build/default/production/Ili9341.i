...
# 216 "./Ili9341.h"
void ili9341_fillrect(int x,int y,int w,int h,int color);
# 226 "./Ili9341.h"
void ili9341_drawrect(int x,int y,int w,int h,int color);
...
void ili9341_init(void)
{
    ...
    ili9341_write_date(0x5C);
    ili9341_write_date(0x4C);

    ili9341_write_command(0xC7);
    ili9341_write_date(0x94);

    ili9341_write_command(0x36);
    ili9341_write_date(0x48);
    ...
    ili9341_write_date(0x08);
    ili9341_write_command(0x26);
    ili9341_write_date(0x01);
    ili9341_write_command(0xE0);
    ili9341_write_date(0x1F);
    ili9341_write_date(0x1a);
    ili9341_write_date(0x18);
    ili9341_write_date(0x0a);
    ili9341_write_date(0x0f);
    ili9341_write_date(0x06);
    ili9341_write_date(0x45);
    ili9341_write_date(0x87);
    ili9341_write_date(0x32);
    ili9341_write_date(0x0a);
    ili9341_write_date(0x07);
    ili9341_write_date(0x02);
    ili9341_write_date(0x07);
    ili9341_write_date(0x05);
    ili9341_write_date(0x00);
    ili9341_write_command(0xE1);
    ili9341_write_date(0x00);
    ili9341_write_date(0x25);
    ili9341_write_date(0x27);
    ili9341_write_date(0x05);
    ili9341_write_date(0x10);
    ili9341_write_date(0x09);
    ili9341_write_date(0x3a);
    ili9341_write_date(0x78);
    ili9341_write_date(0x4d);
    ili9341_write_date(0x05);
    ili9341_write_date(0x18);
    ili9341_write_date(0x0d);
    ...
    ili9341_write_command(0x20);
    ili9341_write_command(0xB7);
    ili9341_write_date(0x07);

    ili9341_write_command(0xB6);
    ili9341_write_date(0x0A);
    ili9341_write_date(0x82);
    ili9341_write_date(0X27);
    ili9341_write_date(0x00);
...
void ili9341_write_command(unsigned char cmd)
{
    ...
    PORTDbits.RD0 = (cmd & 0x01);
    PORTDbits.RD1 = ((cmd >> 1) & 0x01);
    PORTDbits.RD2 = ((cmd >> 2) & 0x01);
    PORTDbits.RD3 = ((cmd >> 3) & 0x01);
...
void ili9341_write_date(unsigned char date)
{
    ...
    PORTDbits.RD0 = (date & 0x01);
    PORTDbits.RD1 = ((date >> 1) & 0x01);
    PORTDbits.RD2 = ((date >> 2) & 0x01);
    PORTDbits.RD3 = ((date >> 3) & 0x01);
    PORTDbits.RD4 = ((date >> 4) & 0x01);
    PORTDbits.RD5 = ((date >> 5) & 0x01);
    PORTDbits.RD6 = ((date >> 6) & 0x01);
    PORTDbits.RD7 = ((date >> 7) & 0x01);
...
unsigned char ili9341_read(void)
{
    ...
    if(PORTDbits.RD7 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD6 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD5 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD4 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD3 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD2 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD1 == 1) result |= 0x01;
    result <<= 1;
    if(PORTDbits.RD0 == 1) result |= 0x01;
...
{
    ili9341_write_command(0x2A);
    ili9341_write_date(sc >> 8);
    ili9341_write_date(sc & 0x00FF);
    ili9341_write_date(ec >> 8);
    ili9341_write_date(ec & 0x00FF);

    ili9341_write_command(0x2B);
    ili9341_write_date(sp >> 8);
    ili9341_write_date(sp & 0x00FF);
    ili9341_write_date(ep >> 8);
    ili9341_write_date(ep & 0x00FF);
...
void ili9341_pushcolor(int color)
{
    ...
    ili9341_write_date(color & 0x00FF);
...
{
    uint8_t j, k, i;
    uint16_t iOffset = fIndex + (font[fIndex])*2;

    for(j=0; j < font[fIndex]; j++)
    {
        ili9341_setcursor(x + font[fIndex] - j, y);

        for(k=0; k<2; k++)
        {
            for(i=0; i<8; i++)
            {
                if( font[ iOffset - (j*2) - k ] & (0x80 >> i) )
                {
                    ili9341_pushcolor(color);
                }
                else
...
{
    ili9341_write_command(0x2B);
    ili9341_write_date(x >> 8);
    ili9341_write_date(x & 0xFF);

    ili9341_write_command(0x2C);

    ili9341_write_command(0x2A);
    ili9341_write_date(y >> 8);
...
void ili9341_draw_circle(int16_t xm, int16_t ym, int16_t r, uint16_t color)
{
    ...
    do
    {
        ili9341_drawpixel(xm-x, ym+y, color);
        ili9341_drawpixel(xm-y, ym-x, color);
        ili9341_drawpixel(xm+x, ym-y, color);
        ili9341_drawpixel(xm+y, ym+x, color);
