...
# 2 "<built-in>" 2
# 1 "Task_Com_USART.c" 2
# 1 "./Task_Com_USART.h" 1
...
# 28 "./OS_CONFIG.h" 2
# 43 "./OS_CONFIG.h"
unsigned char Timer_Task1=2,Timer_Task2=7,Timer_Tec=7,Blocked=0;
unsigned int Timer_Rtc=100,Timer_DelayLcd=300,Timer_DelayMuestra=50,Timer_Puerta1=700,Timer_Puerta2=700,Timer_Hash=700,Timer_RX=20;
...
void OS_init(void);
void __attribute__((picinterrupt(("high_priority")))) ISR_HighP(void);
void __attribute__((picinterrupt(("low_priority")))) ISR_LowP(void);
void TaskDetected(void);
# 10 "./Task_Com_USART.h" 2
# 26 "./Task_Com_USART.h"
...
_Bool Bluetooth_Com(void)
{
    ...
    if(strcmp(word,"s1_on.") == 0) LATEbits.LATE1 = 1,switch_est=1;
    else if(strcmp(word,"s1_off.") == 0)LATEbits.LATE1 = 0,switch_est=1;
    if(strcmp(word,"s2_on.") == 0) LATEbits.LATE0 = 1,switch_est=1;
    else if(strcmp(word,"s2_off.") == 0)LATEbits.LATE0 = 0,switch_est=1;

    if(strcmp(H_P1_txt,word) == 0) LATEbits.LATE1=1,puerta1=1;
    if(strcmp(H_P2_txt,word) == 0) LATEbits.LATE0=1,puerta2=1;
    else if(strcmp(actualizar_txt,word) == 0)
    {
        if(PORTDbits.RD6 == 1) UART_array("1: Abierta");
        else UART_array("1: Cerrada");
        if(PORTDbits.RD7 == 1) UART_array("2: Abierta");
...
void ACN_PA_Com(void)
{
    ...
    switch(N)
    {
        ...
        case 1:
        {
            ...
            if(Ha_Pu == 1)
            {
                if((YY == 01) && (PORTDbits.RD6 == 0)) LATEbits.LATE1=1,puerta1=1,puerta2=0;
                else LATEbits.LATE1=0;
                if((YY == 02) && (PORTDbits.RD7 == 0)) LATEbits.LATE0=1,puerta2=1,puerta1=0;
                else LATEbits.LATE0=0;
            }
            if(Ha_Pu == 0) LATEbits.LATE1=0,LATEbits.LATE0=0;
...
void ACN_CO_Com(void)
{
    ...
    switch(N)
    {
        ...
        case 1:
        {
            if(XX == 01) if(PORTDbits.RD6 == 1) xx=01, yy=01;
            if(XX == 02) if(PORTDbits.RD7 == 1) xx=02, yy=01;
            if(XX == 01) if(PORTDbits.RD6 == 0) xx=01, yy=00;
            if(XX == 02) if(PORTDbits.RD7 == 0) xx=02, yy=00;
