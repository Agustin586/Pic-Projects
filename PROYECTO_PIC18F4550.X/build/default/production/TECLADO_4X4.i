...
void TEC4x4_init(void)
{
    ...
    LATAbits.LA2 = 1;
    LATAbits.LA3 = 1;
    TRISBbits.TRISB4 = 1, TRISAbits.TRISA0 = 0;
    TRISBbits.TRISB5 = 1, TRISAbits.TRISA1 = 0;
    TRISBbits.TRISB6 = 1, TRISAbits.TRISA2 = 0;
    TRISBbits.TRISB7 = 1, TRISAbits.TRISA3 = 0;
    INTCON2bits.RBPU = 0;
 ...
 void escaneo(void)
{
    ...
    for(char j=0;j<4;j++)
    {
        for(char i=0;i<=4;i++)
        {
            if(!PORTAbits.RA0 && i==0)
            {
                LATAbits.LA0 = 1;
                LATAbits.LA1 = 0;
            }
            if(!PORTAbits.RA1 && i==1)
            {
                LATAbits.LA1 = 1;
                LATAbits.LA2 = 0;
            }
            if(!PORTAbits.RA2 && i==2)
            {
                LATAbits.LA2 = 1;
                LATAbits.LA3 = 0;
            }
            if(!PORTAbits.RA3 && i==4)
            {
                LATAbits.LA3 = 1;
            }
        }
...
void antirrebote(void)
{
    ...
    while(PORTBbits.RB4 == 0 || PORTBbits.RB5 == 0 || PORTBbits.RB6 == 0 || PORTBbits.RB7 == 0) _delay((unsigned long)((10)*(48000000/4000.0)));
