...
# 20 "Proyecto_Juego.c" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c90\\time.h" 1 3



# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\__unsupported.h" 1 3
# 4 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c90\\time.h" 2 3
...
# 47 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c90\\time.h" 3
...
void main(void) {
    ...
    while(1){
        ...
        while(RA3==0 && RA2==0 && RA1==0 && RA0==0){
            RB1=1,RB0=1,RB2=1,RB3=1;
            _delay((unsigned long)((200)*(4000000/4000.0)));
            RB1=0,RB0=0,RB2=0,RB3=0;
            _delay((unsigned long)((200)*(4000000/4000.0)));
        }
        if(RA3==1) nivel=1;
        if(RA2==1) nivel=2;
...
void reseteo(void){
    ...
    RB1=1,RB0=1,RB2=1,RB3=1,RB5=1;

    _delay((unsigned long)((1000)*(4000000/4000.0)));

    RB1=0,RB0=0,RB2=0,RB3=0,RB5=0;
...
char verificacion(int arreglo[],char cantidad){
    ...
    while(x<=cantidad && aux==0){
        ...
        if(sec[x]==1){
            ...
            else if(RA2==1 || RA1==1 || RA0==1) aux=1;
        ...
        if(sec[x]==2){
            ...
            else if(RA3==1 || RA1==1 || RA0==1) aux=1;
        ...
        if(sec[x]==3){
            ...
            else if(RA3==1 || RA2==1 || RA0==1) aux=1;
        ...
        if(sec[x]==4){
            ...
            else if(RA3==1 || RA1==1 || RA2==1) aux=1;
